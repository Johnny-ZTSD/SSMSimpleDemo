...
(function(Ea, Q, k) {
    var P = function(h) {
        ...
        r("page()", function(a) {
            return a === k ? this.page.info().page : this.iterator("table", function(b) { Ta(b, a) })
        });
        ...
        r("ajax.url().load()", function(a, b) {
            return this.iterator("table", function(c) { Ub(c, !1 === b, a) })
        });
        ...
        v("cells().invalidate()", "cell().invalidate()", function(a) {
            return this.iterator("cell", function(b, c, e) { ca(b, c, a, e) })
        });
        r("cell()",
            function(a, b, c) {
        ...
        r("order.listener()", function(a, b, c) {
            return this.iterator("table", function(e) { Oa(e, a, b, c) })
        });
        ...
        h.each(["column", "row", "cell"], function(a, b) {
            r(b + "s().every()", function(a) {
                return this.iterator(b, function(e, d, f) { a.call((new t(e))[b](d, f)) })
            })
        });
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                oPaginate: { sFirst: "首页", sLast: "Last", sNext: "下一页", sPrevious: "上一页" },
                // oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" },
                // oPaginate: { sFirst: "First", sLast: "Last", sNext: "Next", sPrevious: "Previous" },
                sEmptyTable: "表格中没有可获得的数据",
                // sEmptyTable: "No data available in table",

                sInfo: "显示 _START_ 到 _END_ 条记录 (共 _TOTAL_ 条) ",
                // sInfo: "Showing _START_ to _END_ of _TOTAL_ entries",   
                sInfoEmpty: "显示 0 到 0 的 ( 0 ) 的记录",
                // sInfoEmpty: "Showing 0 to 0 of 0 entries",    
                sInfoFiltered: "(共过滤掉 _MAX_ 条记录)",
